...
class ApplicationModelForm(forms.ModelForm):
    ...
    MAJORS = (
        ...
        ("Educational Administration & Human Resource Development", "Educational Administration & Human Resource Development"),
        ...
        ("Engineering Technology & Industrial Distribution", "Engineering Technology & Industrial Distribution"),
        ("English", "English"),
        ...
        ("Industrial and/or Systems Engineering", "Industrial and/or Systems Engineering"),
        ("Information Science", "Information Science"),
        ("Information and Operations Management", "Information and Operations Management"),
        ("International Affairs", "International Affairs"),
        ("International Studies", "International Studies"),
        ("Landscape Architecture & Urban Planning", "Landscape Architecture & Urban Planning"),
        ...
        ("Microbial Pathogenesis and Immunology", "Microbial Pathogenesis and Immunology"),
    ...
    major = forms.MultipleChoiceField(choices=MAJORS)
    minor = forms.MultipleChoiceField(choices=MAJORS)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["agree_to_data_sharing"].label = mark_safe(
        ...
        self.fields["learner_pack"].label = mark_safe(
            'I would like to add on the learner pack.'
        )
    ...
    class Meta:
        ...
        widgets = {
            ...
            "agree_to_data_sharing": forms.CheckboxInput,
            ...
            "github_link": forms.TextInput(
                attrs={
                    "placeholder": "ex. github.com/tamu-datathon-org"
                }
            ),
            "linkedin_link": forms.TextInput(
                attrs={
                    "placeholder": "ex. linkedin.com/tamudatathon"
                }
            ),
            "personal_website_link": forms.TextInput(
                attrs={
                    "placeholder": "ex. tamudatathon.com"
                }
            ),
            "instagram_link": forms.TextInput(
                attrs={
                    "placeholder": "ex. instagram.com/tamudatathon"
                }
            ),
            "devpost_link": forms.TextInput(
                attrs={
                    "placeholder": "ex. devpost.com/tamudatathon"
                }
            ),
        }
